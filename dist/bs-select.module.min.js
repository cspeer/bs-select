...
*/class l{#b="bss-wrapper";#n="dropdown-item";#f="bss-items";#L="bss-clear";#g="dropdown-header";#s="d-none";#w="bss-no-results";#E="bss-tag-remove";#t;#o;#y;#$;#x;#e;#S;#l;#i;#a;#d;#r;#h;#c;constructor(e,t){this.#t=e,this.#o=t?.search??e.dataset.bssSearch!==void 0,this.#y=t?.create??e.dataset.bssCreate!==void 0,this.#$=t?.clear??e.dataset.bssClear!==void 0,this.#x=t?.maxHeight||e.dataset.bssMaxHeight||"25rem",this.#e={placeholder:"",search:"Search",noResults:"No results found",clear:"Clear selection",addElement:'Press Enter to add "<b>%{value}</b>"'},this.#e=t?.labels?{...this.#e,...t.labels}:this.#e,this.#S=(this.#t.dataset.bssAutoClose||t?.autoClose)??!0,this.#M(),this.#u(),this.#C()}#M(){this.#t.nextElementSibling&&this.#t.nextElementSibling.classList&&this.#t.nextElementSibling.classList.contains(this.#b)&&this.#t.nextElementSibling.remove();const e=`
